...
//        streamExecutionEnvironment.getConfig().enableObjectReuse();
        ...
        if (JOB_TYPE.startsWith("frame_multi_")) {
            ...
            speedEventDataStreamSink.writeAsText("./output-" + JOB_TYPE + "_alternative" + " parallelism " + streamExecutionEnvironment.getParallelism(), FileSystem.WriteMode.OVERWRITE);
